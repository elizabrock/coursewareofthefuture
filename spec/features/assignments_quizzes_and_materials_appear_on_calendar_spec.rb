...
feature "Assignments quizzes and materials appear on calendar" do
  ...
  scenario "Fix: Multiple milestones on a day" do
    ...
    visit course_calendar_path(course)
    page.should have_calendar_entry("2014-01-02", text: "Koans: Pt. 1 Due")
    page.should have_calendar_entry("2014-01-02", text: "Koans: Pt. 2 Due")
  end
  ...
  scenario "Fix: Multiple quizzes on a day" do
    ...
    visit course_calendar_path(course)
    page.should have_calendar_entry("2014-01-01", text: "Baseline Knowledge Due")
    page.should have_calendar_entry("2014-01-01", text: "Midpoint Checkin Due")
  end
  ...
  scenario "Fix: multiple covered materials on a day" do
    ...
    visit course_calendar_path(course)
    page.should have_calendar_entry("2014-01-15", text: "Logic")
    page.should have_calendar_entry("2014-01-15", text: "Set Theory")
  end
end
